...
export default function Home() {
                ...
                <form onSubmit={handleSearch} className="flex justify-center">
                  <div className="relative w-full max-w-2xl">
                    <input
                      ...
                      className="w-full p-4 pr-12 rounded-full border-2 border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      value={searchTerm}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Avasaram - Advanced Job Portal</title>
        <meta name="description" content="Find your dream job with Avasaram" />
      </Head>
